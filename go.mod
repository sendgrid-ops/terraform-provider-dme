module github.com/sendgrid-ops/terraform-provider-dme
...
require (
	...
	github.com/hashicorp/terraform v0.9.8
	...
	github.com/soniah/dnsmadeeasy v0.0.0-20151118203714-6e1609eb9e02
